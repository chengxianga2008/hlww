...
global $use_uploaded_logo, $custom_logo_image, $custom_logo_image_responsive, $custom_logo_max_width, $has_responsive_image, $s;
				...
				<nav class="main-menu-env top-menu-type-2">
					...
					<form action="<?php echo home_url(); ?>" method="get" class="search-form" enctype="application/x-www-form-urlencoded">
						...
						<div class="search-input-env<?php echo trim(lab_get('s')) ? ' visible' : ''; ?>">
							<input type="text" class="search-input" name="s" placeholder="<?php _e('Search...', 'oxygen'); ?>" value="<?php echo esc_attr( stripslashes( $s ) ); ?>">
					...
					<div class="sec-nav">
						...
						<nav class="main-menu-env">
							...
							<form action="<?php echo home_url(); ?>" method="get" class="search-form" enctype="application/x-www-form-urlencoded">
								...
								<div class="search-input-env<?php echo trim(lab_get('s')) && HEADER_TYPE == 2 ? ' visible' : ''; ?>">
									<input type="text" class="search-input" name="s" alt="" placeholder="<?php _e('Search...', 'oxygen'); ?>" value="<?php echo esc_attr( $s ); ?>" />
									<input type="hidden" name="post_type" value="product" />
								</div>
					...
					<div class="navs">
						...
						<nav class="main-menu-env">
							...
							<form action="<?php echo home_url(); ?>" method="get" class="search-form" enctype="application/x-www-form-urlencoded">
								...
								<div class="search-input-env<?php echo trim(lab_get('s')) && HEADER_TYPE == 2 ? ' visible' : ''; ?>">
									<input type="text" class="search-input" name="s" alt="" placeholder="<?php _e('Search...', 'oxygen'); ?>" value="<?php echo esc_attr( stripslashes( $s ) ); ?>" />
									<input type="hidden" name="post_type" value="product" />
								</div>
