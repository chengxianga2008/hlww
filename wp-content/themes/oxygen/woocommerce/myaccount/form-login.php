	...
	<div class="white-block block-pad">
		...
		<form method="post" class="login">
			...
			<p class="form-row">
				...
				<input type="submit" class="woocommerce-Button button btn btn-default full-width-btn up" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" />
		...
		<div class="white-block block-pad">
			...
			<form method="post" class="register">
				...
				<p class="woocomerce-FormRow form-row">
					...
					<input type="submit" class="woocommerce-Button button btn btn-default full-width-btn up" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>" />
				</p>
