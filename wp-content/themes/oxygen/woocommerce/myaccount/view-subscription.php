	...
	<div class="col-sm-6">
		...
		<div class="white-block block-pad">
			<?php if ( $notes = $subscription->get_customer_order_notes() ) :
				?>
				<h4 class="with-divider"><?php esc_html_e( 'Subscription Updates', 'woocommerce-subscriptions' ); ?></h4>
			...
			<h4 class="with-divider"><?php esc_html_e( 'Subscription Totals', 'woocommerce-subscriptions' ); ?></h4>
			...
			<header>
				<h4 class="with-divider"><?php esc_html_e( 'Customer details', 'woocommerce-subscriptions' ); ?></h4>
			</header>
