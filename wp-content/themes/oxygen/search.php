...
query_posts(array(
	"posts_per_page"   => apply_filters( 'oxygen_search_results_per_page', $results_count ),
	"s"                => $s,
	"paged"            => $page_num,
				...
				<div class="col-sm-8">
					...
					<div class="results-text">
						<h3>
							...
							<span class="search-text">&quot;<?php echo esc_html( stripslashes( $s ) ); ?>&quot;</span>
						</h3>
...
<section class="search-results">
	<div class="row">
		<?php if(have_posts()): ?>
			...
			<?php $i = 0; while(have_posts()): the_post(); global $post; ?>
			<div class="col-sm-4">
			...
			<?php echo ( $i + 1 ) % 3 == 0 ? '<div class="clear"></div>' : ''; ?>
